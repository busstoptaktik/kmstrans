...
# A MAPPING FROM SPECIAL DATUMS TO ALLOWED H_SYSTEMS, THE REGION MAP
# SHOULD BE CONSIDERED AS A DEFAULT,
DATUM_ALLOWED_H_SYSTEMS = {
    "feh10": ["E", "fcsvr10", "_"], "detrs89": ["E", "dhhn92", "_"]}
# DK
...
# FO
SYSTEMS_FO = ["fotmH_h_fvr09", "utm29Hetrs89_h_fvr09",
              "geoHetrs89_h_fvr09", "fkeH_h_fvr09", "fk89H_h_fvr09"]
H_SYSTEMS_FO = ["E", "fvr09", "foldmsl", "_"]
# GR
SYSTEMS_GR = ["utm22Ngr96", "utm24Ngr96", "utm26Ngr96", "geoNgr96",
              "crt_gr96", "mrc0Ngr96", "utm22Nqornoq", "geoNqornoq"]
H_SYSTEMS_GR = ["E", "N", "_"]
# WORLD
SYSTEMS_WORLD = ["webmrcE", "mrc0Ewgs84",
                 "geoEwgs84", "crt_wgs84", "npstgEwgs84"]
...
H_SYSTEMS = {REGION_DK: H_SYSTEMS_DK, REGION_FO: H_SYSTEMS_FO, REGION_GR: H_SYSTEMS_GR,
             REGION_WORLD: H_SYSTEMS_WORLD, REGION_FEHMARN: H_SYSTEMS_FEHMARN}
...
ANGULAR_UNIT_NT = "nt"
ANGULAR_UNIT_SX = "sx"
ANGULAR_UNITS = [ANGULAR_UNIT_DEGREES,
                 ANGULAR_UNIT_RADIANS, ANGULAR_UNIT_NT, ANGULAR_UNIT_SX]
LOGR = 7
LOGM = 3
LOGS = 2
LOGD = 5
    ...
    if geo_unit == ANGULAR_UNIT_NT or geo_unit == ANGULAR_UNIT_SX:
        ...
        if geo_unit == ANGULAR_UNIT_NT:
            ...
            if (60.0 - m) < 10**(-precision - LOGM):  # double check this logic
                ...
                # between 0 and 1 - thus output below 60
                s = (m - floor(m)) * 60
...
# geo_unit acts as a default if unit is not specified...
def translateToDegrees(x, geo_unit):
