...
class WidgetBase(QtGui.QWidget):
    ...
    # Store this handle if you want to interact with the main window - it is
    # also possible to modify the main window through this handle.

    def __init__(self, parent):
        QtGui.QWidget.__init__(self, parent)
    # Implement this methos to handle textual call back messages from the
