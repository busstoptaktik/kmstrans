...
#
# Created: Thu Sep 26 17:09:42 2013
...
class Ui_Dialog(object):
    def setupUi(self, Dialog):
        ...
        self.chb_invert_xy = QtGui.QCheckBox(self.groupBox_6)
        self.chb_invert_xy.setObjectName(_fromUtf8("chb_invert_xy"))
        self.horizontalLayout_6.addWidget(self.chb_invert_xy)
        self.chb_crt_xyz = QtGui.QCheckBox(self.groupBox_6)
        self.chb_crt_xyz.setChecked(True)
        self.chb_crt_xyz.setObjectName(_fromUtf8("chb_crt_xyz"))
        self.horizontalLayout_6.addWidget(self.chb_crt_xyz)
        ...
        self.chb_lazyh = QtGui.QCheckBox(self.groupBox_3)
        self.chb_lazyh.setObjectName(_fromUtf8("chb_lazyh"))
        self.verticalLayout_2.addWidget(self.chb_lazyh)
    ...
    def retranslateUi(self, Dialog):
        ...
        self.chb_output_units.setToolTip(_translate("Dialog", "<html><head/><body><p>Append units, e.g. dg, sx, nt, rad or m, to output coordinates.</p></body></html>", None))
