...
class DialogFile2FileSettings(QtGui.QDialog,Ui_Dialog_f2f):
	...
	def __init__(self,parent,settings):
		...
		self.chb_output_units,self.chb_has_z,self.chb_invert_xy,self.chb_crt_xyz,self.chb_lazyh,self.chb_copy_bad,self.chb_kms_no_units]
